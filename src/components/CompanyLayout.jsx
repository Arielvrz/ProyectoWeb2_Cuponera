...
const navLinks = [
  ...
  { to: "/empresa/ofertas/nueva", label: "Nueva Oferta" },
  { to: "/empresa/empleados", label: "Empleados" },
];
    ...
    <div className="min-h-screen bg-darkBg text-textMain flex font-serif">
      <aside className="w-60 shrink-0 bg-darkSurface border-r border-gray-800 flex flex-col">
        <div className="p-6 border-b border-gray-800">
          <Link to="/empresa/ofertas" className="text-xl font-bold tracking-widest text-accentRed uppercase">
            La Cuponera
          </Link>
          <p className="text-xs text-textMuted mt-1">Panel Empresa</p>
        </div>
